...
func ExampleMap_tags() {
	...
	type Server struct {
		Name    string `column:"server_name"`
		ID      int32  `column:"server_id"`
...
func ExampleMap_omitNested() {
	...
	type Server struct {
		Name string    `column:"server_name"`
		ID   int32     `column:"server_id"`
		Time time.Time `column:"time,omitnested"` // do not convert to map[string]interface{}
	}
...
func ExampleMap_omitEmpty() {
	...
	type Server struct {
		...
		ID       int32  `column:"server_id,omitempty"`
		Location string
	}
...
func ExampleValues_tags() {
	...
	type Server struct {
		...
		ID       int32
		Enabled  bool
		Location Location `column:"-"` // values from location are not included anymore
	}
